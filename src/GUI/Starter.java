		...
		toggleButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				list = new JList(model);
		 		kvittering.add(logic.Product.retrieve(1).getId()); 			
		 		count = 1;
			}
		});
...
//		 });
		...
		btnLeggTil.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				logic.User.create(navn.getText(), redigerNummer.getText(), new logic.Address(redigerGatenavn.getText(), redigerHusnr.getText(), redigerPostnummer.getText(), redigerPoststed.getText()));
